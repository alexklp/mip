...
| `chatgpt_31_MIP_Product_Web_SourceExpansion_Handoff_10_09_2026.md` | Консолідований handoff 05–10.09: product-first Web MVP, Topics/Signals/Sources semantics, локальний незакомічений Topics comparison, source expansion 147→205, ingest capacity/proxy findings, sentiment PAUSED і рекомендований перехід до monitored objects → OPSEC. |
| `chatgpt_32_Topics_Monitored_Cache_Temporal_Operational_Review_16_09_2026.md` | Topics `analyze+maybe`, temporal `as_of` invariants, cache-only NLP і coverage baseline; фіксує operational lock incident та критичний stale SQL-rewrite defect у cache builder, знайдений повторним review після `9f4997b`. |
| `chatgpt_33_Signals_Global_Detection_and_Analyst_Workflow_20_09_2026.md` | Завершений Signals vertical slice: sparse HNSW global detection, bounded snapshot, 24h publication spread, lazy full chronology/evidence, повний candidate publication range, перевірені UI/data contracts та відомий capacity debt. |
